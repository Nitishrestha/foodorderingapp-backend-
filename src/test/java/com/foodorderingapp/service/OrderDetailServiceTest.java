...
public class OrderDetailServiceTest {
    ...
    public void getOrderDetails_thenResultOrderDetailList(){
        when(orderDetailDAO.getOrderDetail()).thenReturn(Arrays.asList(new OrderDetailDto()));
        Assert.assertEquals(orderDetailService.getOrderDetails(),Arrays.asList(new OrderDetailDto()));
    }
